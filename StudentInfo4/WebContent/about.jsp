...
<body style="background: rgba(92,88,116,0.34)">
    ...
    <nav class="navbar navbar-default navbar-static-top">
        ...
        <div class="navbar-default navbar-collapse" id="slider_sub">
            <ul class="nav">
                ...
                <li><a href="${pageContext.request.contextPath}/student?method=findAll"  class="collapse" data-toggle="collapse">学生信息管理<span class="glyphicon glyphicon-chevron-right pull-right"></span></a>
                    
                </li>
                <li><a href="${pageContext.request.contextPath}/classno?method=findAll"  class="collapse" data-toggle="collapse">自习室财产管理<span class="glyphicon glyphicon-chevron-right pull-right"></span></a>
                    
                </li>
                <li><a href="${pageContext.request.contextPath}/course?method=findAll"  class="collapse" data-toggle="collapse">晚归学生信息管理<span class="glyphicon glyphicon-chevron-right pull-right"></span></a>
                    
                </li>
                <li><a href="${pageContext.request.contextPath}/about.jsp"  class="collapse" data-toggle="collapse">报修财产信息管理<span class="glyphicon glyphicon-chevron-right pull-right"></span></a>
    ...
    <!-- 主区域 -->
    <div class="page_main" >
        <div style="width: 100dp;height: 100dp;">
